...
import com.lintyservices.sonar.zamia.ZamiaRunner.RunnerContext;
...
public class ZamiaRunnerTest {
  ...
  public SensorContextTester createContext() {
    return SensorContextTester.create(projectRoot)
      ...
      .setRuntime(SonarRuntimeImpl.forSonarQube(VhdlRcPlugin.SONARQUBE_LTS_VERSION, SonarQubeSide.SCANNER, SonarEdition.COMMUNITY));
  }
