...
import com.lintyservices.sonar.test.utils.SensorTestUtils;
...
public class MetricSensorTest {
  ...
  private static final SonarRuntime SQRT = SonarRuntimeImpl.forSonarQube(VhdlRcPlugin.SONARQUBE_LTS_VERSION, SonarQubeSide.SERVER, SonarEdition.COMMUNITY);
