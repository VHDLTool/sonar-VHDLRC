 ...
 public void define(Context context) {
  ...
  ImmutableList.Builder<Object> builder = ImmutableList.builder();
      ...
      MetricSensor.class
        ...
        .name("Top Entities")
        .description("Toplevel Entity. Should be uppercased. This parameter also affects vhdlrcsynth script's behaviour, if used with autoexec. \r\n" + "Format:  LIBRARY.ENTITY(ARCHITECTURE) \r\n" + "Example: WORK.My_entity(Rtl)")
        .index(2)
	    ...
	    builder.add(PropertyDefinition.builder(BuildPathMaker.KEEP_SOURCE_KEY)
		          ...
		          .subCategory("Rcsynth")
		          .name("Keep sources")
		          .description("Keep source files in /vhdl directory when scanner is run with debug option if true")
		          .type(PropertyType.BOOLEAN)
	    ...
	    builder.add(PropertyDefinition.builder(BuildPathMaker.KEEP_REPORTS_KEY)
		          ...
		          .subCategory("Rcsynth")
		          .name("Keep reports")
		          .description("Keep report files in /rule_checker/reporting/rule directory when scanner is run with debug option if true")
		          .type(PropertyType.BOOLEAN)
